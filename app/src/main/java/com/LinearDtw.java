...
public class LinearDtw
{
    ...
    */
      public static void main(String[] args)
      {
         ...
         {
            System.out.println("USAGE:  java LinearDtw timeSeries1 timeSeries2 radius [EuclideanDistance|ManhattanDistance|BinaryDistance]");
            System.exit(1);
         }
         else
         {
            ...
            int[] colToInclude = {0,1,2,3};
            final TimeSeries tsI = new TimeSeries(args[0], colToInclude, true, false, ',');
            final TimeSeries tsJ = new TimeSeries(args[1], colToInclude, true, false, ',');
